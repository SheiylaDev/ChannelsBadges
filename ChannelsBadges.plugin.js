...
class ChannelsBadges {
    ...
    modalVersion(currentVersion, ModalComponents, ModalActions, changelogs, changelogsTitle) {
        const MyModal = (closeCallback) => {
            return BdApi.React.createElement(ModalComponents.ModalRoot, {
                ...
                size: 'small',
                children: [
                    BdApi.React.createElement('div', { className: 'flex_f5fbb7 horizontal__992f6 justifyStart__42744 justifyBetween_b44898 noWrap__5c413 header__6d5ea', style: { flex: '0 0 auto' } }, [
                        BdApi.React.createElement('div', { className: 'flexChild__6e093', style: { flex: '1 1 auto' } }, [
                            BdApi.React.createElement('h1', { className: 'defaultColor__77578 heading-lg-semibold_a200cd defaultColor__87d87', children: `${this.meta.name}` }),
                            BdApi.React.createElement('div', { className: 'defaultColor__77578 text-xs-normal__56c35 date__21306', children: `Version ${currentVersion}` }),
                        ]),
                        BdApi.React.createElement('button', { 'aria-label': 'Close', type: 'button', className: 'flexChild__6e093 close__1080c button_afdfd9 lookBlank__7ca0a colorBrand_b2253e grow__4c8a4', onClick: closeCallback }, [
                    ...
                    BdApi.React.createElement('div', { className: 'content__764ce content__96073 container_bd6694 thin_b1c063 scrollerBase_dc3aa9', style: { overflow: 'hidden scroll', padding: '0 8px 0 0' } }, [
                        BdApi.React.createElement('div', { tabindex: 0, role: 'region' }, [
                            BdApi.React.createElement('h2', { className: 'added_dc4118', style: { marginTop: '0px', marginLeft: '15px' } }, [
                                BdApi.React.createElement('span', { className: '', children: `${changelogsTitle}` }),
                            ]),
                            BdApi.React.createElement('ul', { style: { marginLeft: '35px', marginBottom: '20px' } }, [
                                changelogs.map((log, index) => (BdApi.React.createElement('li', { key: index }, log.trim())))
                            ]),
                        ]),
                    ]),
                    BdApi.React.createElement('div', { className: 'flex_f5fbb7 horizontal__992f6 justifyStart__42744 alignStretch_e239ef noWrap__5c413 footer__89240 footerSeparator__57d95', style: { flex: '0 0 auto' } }, [
                        BdApi.React.createElement('div', { className: 'footer__55d42' }, [
                            BdApi.React.createElement('a', { className: 'anchor_c8ddc0 anchorUnderlineOnHover__78236 socialLink_f11d71', href: 'https://www.paypal.me/Sheiylanie', rel: 'noreferrer noopener', target: '_blank' }, [
                            ...
                            BdApi.React.createElement('div', { className: 'defaultColor__77578 text-xs-normal__56c35', children: `Support me for more updates !` }),
                        ]),
                    ]),
                ]
            });
    ...
    checkVersion(sys) {
        ...
        const changelogsTitle = 'Updates';
        const changelogs = [
            `Fixes latest discord update.`,
            `Thank you to thehamish555 for the help !`,
        ];
        if (sys) {
                    ...
                    if (isWarnTag && this.settings['nsfw'].nsfw) {
                        tagElementHtml = `
                            <div style="display: flex;">
                                <div style="margin-right:5px;" class="textBadge__45d79 base__92a12 eyebrow__60985 baseShapeRound-3epLEv nsfwTags-2409cb">${this.settings['emoji'].emoji ? "🔞 NSFW" : "NSFW"}</div>
                                <div class="textBadge__45d79 base__92a12 eyebrow__60985 baseShapeRound-3epLEv ${tag.className2}">${tagContent}</div>
                            </div>`;
                    } else {
                        tagElementHtml = `<div class="textBadge__45d79 base__92a12 eyebrow__60985 baseShapeRound-3epLEv ${tag.className2}">${tagContent}</div>`;
                    }
    ...
    getSettingsPanel() {
        ...
        const createSettingDescription = (checkbox) => {
            ...
            badgeDiv.className = `textBadge__45d79 base__92a12 eyebrow__60985 baseShapeRound-3epLEv ${checkbox.className}`;
